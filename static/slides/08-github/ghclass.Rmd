...
Collect GitHub account info in a spreadsheet:

<br/>

.center[
![:scale 30%](img/roster.png)
]

---

## RStudio Cloud access
...
```{r eval=FALSE}
create_team_repo("sta771-f18", prefix="hw02-")
```
```
...
```{r eval=FALSE}
mirror_repo(
  source_repo = "sta771-f18/hw02", 
  target_repos = get_repos("sta771-f18","hw02-")
)
```
```
## Cloning source repo (sta771-f18/hw02) ...
## Mirroring sta771-f18/hw02 to sta771-f18/hw02-Team01 ...
## Mirroring sta771-f18/hw02 to sta771-f18/hw02-Team02 ...
## Cleaning up ...
```
...
```{r eval=FALSE}
repos = get_repos("sta771-f18",filter = "hw02-")
